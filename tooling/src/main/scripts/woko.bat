...
echo \ \  _  / /___ ^| ^|/ / ___
echo  \ \/ \/ // o \^|   K /   \
echo   \__W__/ \___/^|_^|\_\\_o_/  2.1-beta9
...
if exist pom.xml (
    ...
    call mvn archetype:generate -DarchetypeArtifactId=woko-archetype -DarchetypeGroupId=com.pojosontheweb -DarchetypeVersion=2.1-beta9 -DgroupId="%GROUPID%" -DartifactId="%ARTIFACTID%" -Dversion="%VERSION%" -DinteractiveMode="false" -q
