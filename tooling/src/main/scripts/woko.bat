...
if exist pom.xml (
    ...
    call mvn archetype:generate -DarchetypeArtifactId=woko-archetype -DarchetypeGroupId=com.pojosontheweb -DarchetypeVersion=2.2 -DgroupId="%GROUPID%" -DartifactId="%ARTIFACTID%" -Dversion="%VERSION%" -DinteractiveMode="false" -q
