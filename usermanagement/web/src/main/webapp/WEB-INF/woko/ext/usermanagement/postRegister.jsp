...
<s:layout-render name="${layout.layoutPath}" layout="${layout}" pageTitle="${pageTitle}">
    <s:layout-component name="body">
        ...
        <fmt:message bundle="${wokoBundle}" key="woko.ext.usermanagement.post.register.para.text">
            <fmt:param value="${postRegister.email}"/>
        </fmt:message>

        <a class="btn btn-large btn-primary" href="${pageContext.request.contextPath}/view/${postRegister.userClassName}/${postRegister.userId}">
