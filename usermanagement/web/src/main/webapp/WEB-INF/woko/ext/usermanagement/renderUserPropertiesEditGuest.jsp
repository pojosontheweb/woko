...
%>
    <div class="control-group ${empty(actionBean.context.validationErrors['facet.password1']) ? '' : 'error'} ">
        <label class="control-label wokoPropertyName java.lang.String-password1" for="facet.password1">Password 1</label>
        <div class="controls">
            <s:errors field="facet.password1"/>
            <s:password name="facet.password1" class="input-xlarge wokoPropertyValueEdit"/>
        </div>
    </div>

    <div class="control-group ${empty(actionBean.context.validationErrors['facet.password1']) ? '' : 'error'} ">
        <label class="control-label wokoPropertyName java.lang.String-password1" for="facet.password1">Password 2</label>
        <div class="controls">
            <s:errors field="facet.password1"/>
            <s:password name="facet.password1" class="input-xlarge wokoPropertyValueEdit"/>
        </div>
