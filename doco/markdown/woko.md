...
They are defined by the interface `woko.facets.FragmentFacet`, and they are backed by a JSP fragment (the "view"). Server-side include is used in order to delegate the rendering of various parts of the page to those facets.
...
Woko extends Stripes' validation system in order to make it work recursively (nested) by default. 
