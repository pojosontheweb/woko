...
<%@ page import="woko.facets.builtin.all.RenderPropertyValueEditEnum" %>
<%
    RenderPropertyValueEditEnum renderPropertyValue = (RenderPropertyValueEditEnum)request.getAttribute(WokoFacets.renderPropertyValueEdit);
    WokoFacetContext fctx = renderPropertyValue.getFacetContext();
    ObjectStore os = fctx.getWoko().getObjectStore();
    String propertyName = renderPropertyValue.getPropertyName();
    String propertyClassName = os.getClassMapping(renderPropertyValue.getEnumClass());
...
<span class="wokoPropertyValueEdit">
    <span class="<%=propertyName%> <%=propertyClassName%>">
        <s:select name="<%=fullFieldName%>">
            ...
            <s:options-enumeration enum="<%=renderPropertyValue.getEnumClass().getName()%>"/>
        </s:select>
    </span>
</span>
