...
<li><a href="${pageContext.request.contextPath}/home"><fmt:message key="woko.devel.navbar.home"/> </a></li>
<li><a href="${pageContext.request.contextPath}/find"><fmt:message key="woko.devel.navbar.find"/> </a></li>
