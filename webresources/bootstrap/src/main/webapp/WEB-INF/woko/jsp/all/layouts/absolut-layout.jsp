        ...
        <div class="container">
            <div class="navbar topnav">
                <div class="row-fluid">
                    <div class="span2">
                        <a href="${cp}/home">
                            <img src="http://farm9.staticflickr.com/8390/8508912093_cebd7a7e2f_q.jpg"/>
                        </a>
                    </div>
                    <div class="span7">
                        <div class="navbar-text">
                            <h1>
                                ${layout.appTitle}
                                <span class="slogan">Add your great slogan here !</span>
                            </h1>
                    ...
                    <div class="span3">
                        ...
                        <div class="row-fluid">
                            ...
                            <c:if test="${not empty username}">
                                <s:form action="/search" class="form-inline pull-right">
                                    <fmt:message bundle="${wokoBundle}" key="search" var="ph"/>
                                    <div class="input-append">
                                        <s:text name="facet.query" class="input-large" placeholder="${ph}"/>
                                        <button class="btn btn-success" type="submit"><i class="icon-white icon-search"></i></button>
                                    </div>
                                </s:form>
