...
class RenderPropertyValueJsonOtherPojo extends BaseFacet<HibernateCompassStore,InMemoryUserManager,RemoteUserStrategy,AnnotatedFacetDescriptorManager> implements RenderPropertyValueJson {
